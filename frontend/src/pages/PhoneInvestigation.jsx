...
import { PhoneCall, Search, AlertTriangle, ShieldCheck, Download, MapPin, Signal, Activity, AlertCircle, Clock, ShieldAlert, CheckCircle, Brain } from 'lucide-react';
...
export default function PhoneInvestigation() {
  ...
  const handleExport = () => {
    ...
    link.href = blobUrl;
    link.setAttribute('download', `investigation_${investigation.id || 'phone'}.json`);
